  ...
  return (
    <div className="mx-auto max-w-4xl p-6 text-slate-950 dark:text-white">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-950 dark:text-white">Daily Review</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700/50 dark:bg-slate-800/50">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-slate-500 dark:text-slate-400">Productivity</span>
          </div>
          <div className="text-3xl font-bold text-slate-950 dark:text-white">
      ...
      <div className="mb-6 rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700/50 dark:bg-slate-800/50">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-slate-500 dark:text-slate-400">Daily Progress</span>
          <span className="font-medium text-slate-950 dark:text-white">{productivityScore}%</span>
        </div>
      ...
      {showReviewForm && (
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700/50 dark:bg-slate-800/50">
          ...
          <textarea
            ...
            rows={4}
            className="mb-4 w-full resize-none rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-950 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:border-slate-600/50 dark:bg-slate-900/50 dark:text-white dark:placeholder-slate-500"
          />
      ...
      {/* Recent Reviews */}
      <div className="mt-6">
        <h2 className="mb-4 text-lg font-semibold text-slate-950 dark:text-white">Recent Reviews</h2>
        <div className="space-y-3">
          {dailyReviews.slice(-5).reverse().map((review) => (
            <div
              key={review.id}
              className="flex items-center justify-between rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700/30 dark:bg-slate-800/30"
            >
              <div>
